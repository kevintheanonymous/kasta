<?php
/**
 * Vue : Liste des participants inscrits à un événement sportif (Admin)
...
<div class="admin-container">
    <div class="header-actions">
        ...
        <div class="actions">
            <a href="<?= url('/admin/events&type=sport') ?>" class="btn btn-secondary">← Retour aux événements</a>
            <a href="<?= url('/admin/creneaux&id_event=' . $event['id_event_sport']) ?>" class="btn btn-primary">Gérer les créneaux</a>
            <a href="<?= url('/admin/events/pdf-participants&id=' . $event['id_event_sport']) ?>" class="btn btn-success">
    ...
    <?php if (empty($creneaux)): ?>
        <div class="alert alert-info">
            ...
            Cet événement n'a pas encore de créneaux. Créez des créneaux pour permettre aux participants de s'inscrire.
        </div>
    <?php else: ?>
        <?php foreach ($creneaux as $creneau): ?>
            <div class="creneau-section">
                ...
                <?php else: ?>
                    <form method="POST" action="<?= url('/admin/creneaux/marquer-presences') ?>" class="form-presences-creneau">
                        <?= champCSRF() ?>
                        <input type="hidden" name="id_creneau" value="<?= $creneau['id_creneau'] ?>">
                        <input type="hidden" name="id_event" value="<?= $event['id_event_sport'] ?>">
                        <input type="hidden" name="retour_url" value="<?= url('/admin/events/benevoles&id=' . $event['id_event_sport']) ?>">
