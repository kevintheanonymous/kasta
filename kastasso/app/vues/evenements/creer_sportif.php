...
<head>
    ...
    <title>Créer un événement sportif - Kast'Asso</title>
...
<body>
    ...
    <form action="index.php?path=/admin_event_sportif_traiter" method="post" enctype="multipart/form-data">
        <label>Titre * :
        ...
        <label>Catégorie d'événement * :
            <select name="id_categorie" required>
                ...
                <?php foreach ($categories as $cat): ?>
                    <option value="<?= $cat['Id_Categorie_evenement'] ?>">
        ...
        <label>Lien Maps * :
            <input type="url" name="lien_maps" required placeholder="https://maps.google.com/..." value="<?= htmlspecialchars($_SESSION['form_data']['lien_maps'] ?? '') ?>">
        </label>
        ...
        <input type="submit" value="Créer l'événement sportif">
    </form>
