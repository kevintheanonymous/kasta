...
<head>
    ...
    <title>Espace Gestionnaire - Kast'Asso</title>
    <link rel="stylesheet" href="<?= asset('css/variables.css?v=' . time()) ?>">
    <link rel="stylesheet" href="<?= asset('css/gabarit.css?v=' . time()) ?>">
    <link rel="stylesheet" href="<?= asset('css/tableau_de_bord_gestionnaire.css?v=' . time()) ?>">
...
<body>
    ...
    <main>
        ...
        <p>Bienvenue <?= htmlspecialchars($_SESSION['user_name'] ?? 'Gestionnaire') ?></p>
            ...
            <section class="section">
                ...
                <div class="admin-events-list">
                    <p style="font-size: 1.1rem;">
                        Il y a actuellement <strong><?= $countSport ?></strong> événements sportifs et <strong><?= $countAsso ?></strong> événements associatifs en ligne.
                    </p>
                </div>
            </section>
        </div>

        <div class="container inscription-events-section">
            <h2 class="section-title-inscription">S'inscrire aux événements</h2>
