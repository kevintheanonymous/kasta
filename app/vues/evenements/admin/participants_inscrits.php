<?php
/**
 * Vue : Liste des participants inscrits à un événement associatif (Admin)
...
<div class="admin-container">
    <div class="header-actions">
        ...
        <div class="actions">
            <a href="<?= url('/admin/events&type=asso') ?>" class="btn btn-secondary">← Retour aux événements</a>
            <a href="<?= url('/admin/events/pdf-participants-asso&id=' . $event['id_event_asso']) ?>" class="btn btn-success">
            ...
            <table class="admin-table">
                <thead>
                    <tr>
                        ...
                        <th class="col-center">Accompagnateurs</th>
                        <th>Paiement</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($participants as $participant): ?>
                        <tr>
                            ...
                            <td>
                                <form action="<?= url('/admin/events/paiement') ?>" method="post" style="display:inline;">
