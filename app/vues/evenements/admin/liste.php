...
?>
    <div class="admin-container">
        ...
        <div class="tabs">
            <a href="<?= url('/admin/events&type=sport') ?>" class="tab <?= $type === 'sport' ? 'active' : '' ?>">Sportifs</a>
            <a href="<?= url('/admin/events&type=asso') ?>" class="tab <?= $type === 'asso' ? 'active' : '' ?>">Associatifs</a>
        </div>

        <div class="actions">
            <?php if ($type === 'sport'): ?>
                <a href="<?= url('/admin/events/create-with-slots&type=' . $type) ?>" class="btn btn-primary">Créer événement + créneaux</a>
            <?php else: ?>
                <a href="<?= url('/admin/events/create&type=' . $type) ?>" class="btn btn-primary">Créer un événement</a>
            <?php endif; ?>
                ...
                <tr>
                    ...
                    <td class="td-actions" data-label="Actions">
                        <div class="actions-buttons">
                            <?php if($type === 'sport'): ?>
                                <a href="<?= url('/admin/events/benevoles&id=' . $event['id_event_sport']) ?>" class="btn btn-action btn-success" title="Participants">
                                    Participants
                                </a>
                            ...
                            <?php if($type === 'asso'): ?>
                                <a href="<?= url('/admin/events/participants&id=' . $event['id_event_asso']) ?>" class="btn btn-action btn-success" title="Participants">
                                    Participants
                                </a>
                            <?php endif; ?>

                            <a href="<?= url('/admin/events/edit&type=' . $type . '&id=' . ($type === 'sport' ? $event['id_event_sport'] : $event['id_event_asso'])) ?>" class="btn btn-action btn-warning" title="Modifier">
                                Modifier
                            </a>

                            <form action="<?= url('/admin/events/delete') ?>" method="post" style="display: inline;" onsubmit="return confirm('Supprimer cet événement ?');">
                                <?= champCSRF() ?>
